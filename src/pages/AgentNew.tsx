...
export function AgentNew({ onCreated, onBack, reviewContent }: { reviewContent?: React.ReactNode; onCreated?: (agent: { id: number; name: string; status: string; warning?: string }) => void; onBack?: () => void } = {}) {
        ...
        <div className="mt-5">
          {step.id === "template" && (
            <TemplateStep
              ...
              onSkipWizard={onBack ? undefined : () => navigate("/agents")}
            />
          )}
          {step.id === "details" && (
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-t border-border p-4">
          <div className="flex flex-wrap items-center gap-3 text-xs text-text-muted">
            ...
            {picker === "apps" && allowAppManagement && (
              <a
                href="/apps"
                target="_blank"
                rel="noreferrer"
